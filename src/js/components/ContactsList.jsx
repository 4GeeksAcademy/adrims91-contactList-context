            ...
            {showModal ? (
                ...
                <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                            <EditContact contactId={editingContactId} onClose={() => setEditingContactId(null)} />
                            </div>
                        </div>
                    </div>
                    </div>
                            ...
                            <div className="card" style={{ width: "16rem" }}>
                                ...
                                <div className="card-body">
                                  <ul className="list-group list-group-">
                                    ...
                                    <li className="list-group-item"><i className="fa-regular fa-envelope me-2"></i> {contact.email}</li>
                                    <li className="list-group-item"><i className="fa-solid fa-phone me-2"></i> {contact.phone}</li>
                                    <li className="list-group-item"><i className="fa-solid fa-location-dot me-2"></i> {contact.address}</li>
                                  </ul>
                                </div>
                                <button 
